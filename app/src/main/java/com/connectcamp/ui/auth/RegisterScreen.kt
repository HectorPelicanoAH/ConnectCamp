...
fun RegisterScreen(
    ...
    var selectedRole by rememberSaveable { mutableStateOf(UserRole.CONSUMER) }
    ...
    LaunchedEffect(currentUser) {
        if (uiState is AuthUiState.Success && currentUser != null) {
            onRegisterSuccess(currentUser!!.role)
            authViewModel.resetState()
        }
    }
        ...
        Column(
            ...
            Row(
                ...
                FilterChip(
                    ...
                    label = { Text(stringResource(R.string.consumer)) },
                    modifier = Modifier.weight(1f)
                )
                FilterChip(
                    selected = selectedRole == UserRole.PRODUCER,
                    onClick = { selectedRole = UserRole.PRODUCER },
            ...
            OutlinedTextField(
                ...
                keyboardActions = KeyboardActions(
                    onDone = {
                        ...
                        authViewModel.register(email, password, confirmPassword, fullName, phone, selectedRole)
                    }
                ),
                singleLine = true,
                modifier = Modifier.fillMaxWidth()
